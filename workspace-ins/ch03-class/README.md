...
## 목차
- [1. 클래스 컴포넌트란?](#1-클래스-컴포넌트란)
  - [1.1 클래스 컴포넌트의 기본 구조](#11-클래스-컴포넌트의-기본-구조)
  - [1.2 Props 사용하기](#12-props-사용하기)
  - [1.3 State 사용하기](#13-state-사용하기)
  - [1.4 함수형 컴포넌트와의 차이점](#14-함수형-컴포넌트와의-차이점)
- [2. 컴포넌트 생명 주기](#2-컴포넌트-생명-주기)
