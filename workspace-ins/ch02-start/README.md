...
* HTML 마크업과 비슷한 문법을 사용해서 UI를 정의하면 Babel, ESBuild 같은 변환 도구에 의해 자바스크립트 코드로 변환됨
  ...
  React.createElement("header", null, 
    React.createElement("h1", null, "02 Counter - React\uB85C \uAD6C\uD604(JSX)"));
  ```
...
* workspace/ch02-start/vite 폴더로 이동 후 다음 명령 실행
  ```bash
  npm create vite@latest 09
  ```
  ...
  │  ● Yes / ○ No
  │
  ◇  Scaffolding project in C:/febc15/...09/...
  │
