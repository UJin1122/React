...
export function getAxios() {
  const instance = axios.create({
    ...
    headers: {
      ...
      Authorization: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOjcsInR5cGUiOiJzZWxsZXIiLCJpYXQiOjE3NjcxNTkyMTksImV4cCI6MTc2NzI0NTYxOSwiaXNzIjoiRkVCQyJ9.bZErMR-WpCH4XQrB3j94TLcXbJcAtc5OjY82_XmNvHA',
    }
  });
