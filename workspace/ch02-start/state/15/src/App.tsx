...
function App(){
  ...
  <>
    ...
    <form onSubmit={ registMember }>
      ...
      <input id="email" name="email" value={ user.email } onChange={ handleNameChange }/><br/>
      <div className="error-style">{ errors.email?.message }</div>

      <label htmlFor="cellphone">휴대폰</label>
      <input id="cellphone" name="cellphone" value={ user.cellphone } onChange={ handleNameChange }/><br/>
