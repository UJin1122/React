...
export default function InfoEdit({ params }: { params: { id: string } }) {
  return (
      ...
      <section className="mb-8 p-4">
        <form action={`/info/${params.id}`}>
          ...
          <div className="flex justify-end my-6">
            ...
            <Link href={`/info/${params.id}`} className="bg-gray-900 py-1 px-4 text-base text-white font-semibold ml-2 hover:bg-amber-400 rounded">취소</Link>
          </div>
        </form>
      </section>
    </main>
